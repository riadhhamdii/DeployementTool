...
;(function($){
	$.contextMenu = {
		...
		shadowOpacity:.2,
		shadowClass:'context-menu-os-shadow',
		shadowColor:'black',
		...
		className:'context-menu-os',
		itemClassName:'context-menu-os-item',
		itemHoverClassName:'context-menu-os-item-hover',
		disabledItemClassName:'context-menu-os-item-disabled',
		disabledItemHoverClassName:'context-menu-os-item-disabled-hover',
		separatorClassName:'context-menu-os-separator',
		innerDivClassName:'context-menu-os-item-inner',
		themePrefix:'context-menu-os-theme-',
		theme:'default',

		separator:'context-menu-os-separator', // A specific key to identify a separator
		...
		createMenu: function(menu,cmenu) {
			...
			var $t = $('<table class="'+cmenu.id+'" cellspacing=0 cellpadding=0></table>').click(function(){cmenu.hide(); return false;}); // We wrap a table around it so width can be flexible
			var $tr = $('<tr></tr>');
			var $td = $('<td></td>');
