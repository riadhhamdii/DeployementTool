...
(function($){
    ...
    $.tooltipsy.prototype.readify = function () {
        this.ready = true;
        this.$tipsy = $('<div id="tooltipsy_' + this.settings.id + '" class="input_tooltip" style="position:absolute;z-index:2147483647;display:none">').append('<div class="input_tooltip-fleche"></div>').append('<div class="input_tooltip-alert"></div>').appendTo('body');
